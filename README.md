...
**Prompt Engineer · AI Systems Builder · Python**

I build AI pipelines, multi-agent systems, and local LLM workflows — mostly in Python, mostly on Apple Silicon.
...
**Local LLMs:** Qwen3.5 · DeepSeek-R1 via MLX on Apple Silicon
...
- **Prompt Engineering** — CLEAR framework, LLM-as-Judge, eval systems, agentic patterns
- **Multi-agent systems** — debate architectures, MCTS, tool use, RAG
- **Local LLMs** — MLX inference on Apple Silicon, hybrid routing (Claude ↔ Qwen)
- **Finance AI** — signal extraction, portfolio optimisation, compliance-aware prompting

---

![GitHub stats](https://github-readme-stats.vercel.app/api?username=Jooooov&show_icons=true&theme=dark&hide_border=true&bg_color=0d1117&title_color=7c6af7&icon_color=a78bfa&text_color=e2e2e2)
